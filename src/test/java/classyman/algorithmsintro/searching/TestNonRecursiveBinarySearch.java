...
/**
 * Tests Binary searching using the {@link NonRecursiveBinarySearch} testing algorithm
 * @author Aidan
 */
public class TestNonRecursiveBinarySearch {
	...
	public void testSearch(TestSearchData testSearchData) {
		SearchResult searchResult = NonRecursiveBinarySearch.construct().withInput(testSearchData.input).find(testSearchData.elementToFind);
